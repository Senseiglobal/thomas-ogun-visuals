...
const auraUserFlowSteps = [
  {
    number: "01",
    title: "Landing Page",
    image: "assets/images/aura/user-flow/landing-page.png",
  ...
  },
  {
    ...
    image: "assets/images/aura/user-flow/authentication.png",
  ...
  },
  {
    number: "03",
    title: "Loading State",
    image: "assets/images/aura/user-flow/loading-state.png",
  ...
  },
  {
    ...
    image: "assets/images/aura/user-flow/empty-workspace.png",
  ...
  },
  {
    number: "05",
    title: "AI Processing",
    image: "assets/images/aura/user-flow/ai-processing.png",
  ...
  },
  {
    ...
    image: "assets/images/aura/user-flow/response-workspace.png",
  ...
  return `
    <article class="user-flow-card">
      <div class="user-flow-media">
        <img src="${escapeHTML(step.image)}" alt="${escapeHTML(step.title)} screen from Aura Manager" loading="lazy">
      </div>
